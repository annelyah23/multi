...
wget -q -O /usr/bin/addxtls "https://raw.githubusercontent.com/bakulssh/multi/main/xtls/add.sh" && chmod +x /usr/bin/addxtls
wget -q -O /usr/bin/delxtls "https://raw.githubusercontent.com/bakulssh/multi/main/xtls/del.sh" && chmod +x /usr/bin/delxtls
wget -q -O /usr/bin/cekxtls "https://raw.githubusercontent.com/bakulssh/multi/main/xtls/chk.sh" && chmod +x /usr/bin/cekxtls
wget -q -O /usr/bin/renewxtls "https://raw.githubusercontent.com/bakulssh/multi/main/xtls/rnw.sh" && chmod +x /usr/bin/renewxtls