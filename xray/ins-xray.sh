...
PERMISSION () {
    ...
    res="Permission Denied! hub https://t.me/amantubilah"
    fi
    BURIQ
}
clear
...
#nginx config
wget -O /etc/nginx/conf.d/xray.conf "https://raw.githubusercontent.com/arismaramar/multi/main/xray/xray.conf"  && chmod +x /etc/nginx/conf.d/xray.conf
