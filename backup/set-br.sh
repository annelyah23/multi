...
wget -q -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/arismaramar/multi/main/backup/rclone.conf"
...
wget -q -O /usr/bin/cleaner "https://raw.githubusercontent.com/arismaramar/multi/main/backup/logcleaner.sh" && chmod +x /usr/bin/cleaner
